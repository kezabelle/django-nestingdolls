...
PYTHON_FILES := demo.py nestingdolls test_composite.py test_dictfield.py test_hostile.py test_listfield.py test_patches.py mypy_settings.py
...
test: ## Run the Django test files.
	$(PYTHON) -W error::DeprecationWarning -W error::PendingDeprecationWarning -m unittest test_composite test_listfield test_dictfield test_hostile test_patches
